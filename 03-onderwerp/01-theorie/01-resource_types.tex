...
\subsection{Parameters}
	...
	backup:
	Of er een backup van bestanden dient gemaakt te worden voordat ze vervangen worden. De manier bij voorkeur is om hierbij de filebucket te gebruiken.\\
	De filebucket slaat bestanden op en herkent ze via hun md5-som, en zorgt voor een simpele overdraginsgmethode, alsook een opgeruimde mapenstructuur.\\
%
